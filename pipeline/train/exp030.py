...
AUGMENT_VOLUME_MUL_PARAMS = [0,1, 0.25, 0.5, 0.6, 0.7, 0.8, 0.9, 0.95]
AUGMENT_VOLUME_AUG_RATE = 0.8
...
def train(cfg: DictConfig):
    ...
    cfg.dataset.augment.volume_mul_params = AUGMENT_VOLUME_MUL_PARAMS
    cfg.dataset.augment.volume_aug_rate = AUGMENT_VOLUME_AUG_RATE
