...
#TRAIN_DATASET_LIST =  ["/data/jvs_vc", "/data/common_voice", "/data/lecture_vc", "/data/vc_dataset", "/data/voxceleb1_dev", "/data/voxceleb2_dev"]
...
def train(cfg: DictConfig):
    ...
    cfg.dataset.test.dataset_list = TRAIN_DATASET_LIST
